    ...
    <>
      ...
      */}
      <div className="min-h-full">
        <Popover
          as="header"
          className="bg-linear-to-r from-sky-800 to-cyan-600 pb-24"
        >
            ...
            <div className="relative flex flex-wrap items-center justify-center lg:justify-between">
              ...
              <div className="absolute left-0 shrink-0 py-5 lg:static">
                <a href="#">
                  ...
                  <img
                    alt=""
                    src="https://tailwindcss.com/plus-assets/img/logos/mark.svg?color=cyan&shade=200"
              ...
              <div className="hidden lg:ml-4 lg:flex lg:items-center lg:py-5 lg:pr-0.5">
                <button
                  type="button"
                  className="relative shrink-0 rounded-full p-1 text-cyan-200 hover:bg-white/10 hover:text-white focus:ring-2 focus:ring-white focus:outline-hidden"
                >
                  ...
                  <div className="px-12 lg:px-0">
                    ...
                    <div className="mx-auto grid w-full max-w-xs grid-cols-1 lg:max-w-md">
                      <input
                        ...
                        placeholder="Search"
                        aria-label="Search"
                        className="peer col-start-1 row-start-1 block w-full rounded-md bg-white/20 py-1.5 pr-3 pl-10 text-base text-white outline-hidden placeholder:text-white focus:bg-white focus:placeholder:text-gray-400 sm:text-sm/6"
                      />
                      <MagnifyingGlassIcon
                        aria-hidden="true"
              ...
              <div className="absolute right-0 shrink-0 lg:hidden">
                {/* Mobile menu button */}
                <PopoverButton className="group relative inline-flex items-center justify-center rounded-md bg-transparent p-2 text-cyan-200 hover:bg-white/10 hover:text-white focus:ring-2 focus:ring-white focus:outline-hidden">
              ...
              <div className="divide-y divide-gray-200 rounded-lg bg-white shadow-lg ring-1 ring-black/5">
                <div className="pt-3 pb-2">
                  <div className="flex items-center justify-between px-4">
                    ...
                    <div className="-mr-2">
                      <PopoverButton className="relative inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:ring-2 focus:ring-cyan-500 focus:outline-hidden focus:ring-inset">
                        <span className="absolute -inset-0.5" />
                ...
                <div className="pt-4 pb-2">
                  <div className="flex items-center px-5">
                    ...
                    <button
                      type="button"
                      className="relative ml-auto shrink-0 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500 focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:outline-hidden"
                    >
                      <span className="absolute -inset-1.5" />
                      <span className="sr-only">View notifications</span>
                      <BellIcon aria-hidden="true" className="size-6" />
                  ...
                  <div className="overflow-hidden rounded-lg bg-white shadow-sm">
                    <div className="p-6">
                      ...
                      <div className="mt-6">
                        <a
                          href="#"
                          className="flex w-full items-center justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50"
                        >
                          View all
                        </a>
                      </div>
                            ...
                            <li key={person.handle} className="py-4">
                              <div className="flex items-center space-x-4">
                                ...
                                <div>
                                  <a
                                    href={person.href}
                                    className="inline-flex items-center rounded-full bg-white px-2.5 py-1 text-xs font-semibold text-gray-900 shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-gray-50"
                                  >
                                    View
                                  </a>
                                </div>
