...
- `@eliseoeric/ui`: a stub React component library shared by both `web` and `docs` applications
- `@eliseoeric/eslint-config`: `eslint` configurations (includes `eslint-config-next` and `eslint-config-prettier`)
- `@eliseoeric/typescript-config`: `tsconfig.json`s used throughout the monorepo
