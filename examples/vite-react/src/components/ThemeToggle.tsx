    ...
    <section className="space-y-6">
      ...
      <div className="p-6 border border-gray-200 rounded-lg space-y-4">
        ...
        <Typography variant="body" className="text-sm text-gray-600">
          Notice how the colors change when you switch themes. This is powered by 
          CSS custom properties that are dynamically updated based on the data-brand attribute.
        </Typography>
      </div>
    </section>
  )
