    ...
    return (
      <>
        ...
        >
          ...
          <AlertDescription>
            This is a smaller alert for brief messages.
          </AlertDescription>
          <AlertActions>
            <Button color="primary" onClick={() => setIsOpen(false)}>
              OK
    ...
    return (
      <>
        ...
        >
          ...
          <AlertDescription>
            This is a larger alert that can accommodate more detailed
            information and longer descriptions. It provides more space for
            comprehensive explanations and multiple action buttons.
          </AlertDescription>
          <AlertActions>
            <Button color="secondary" plain onClick={() => setIsOpen(false)}>
              Not Now
