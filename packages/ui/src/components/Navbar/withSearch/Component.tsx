        ...
        <div className="flex h-16 justify-between">
          ...
          <div className="hidden lg:ml-4 lg:flex lg:items-center">
            ...
            <Menu as="div" className="relative ml-4 shrink-0">
              <MenuButton className="relative flex rounded-full focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand dark:focus-visible:outline-brand">
                <span className="absolute -inset-1.5" />
